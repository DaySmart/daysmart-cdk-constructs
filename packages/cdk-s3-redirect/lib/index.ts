...
export class CdkS3Redirect extends cdk.Construct {
  constructor(scope: cdk.Construct, id: string, props: CdkS3RedirectProps) {
    ...
    const httpOriginCachePolicy = cloudfront.CachePolicy.fromCachePolicyId(this, "HttpOriginCachePolicy", props.httpOriginCachePolicyId);
    const httpOriginRequestPolicy = cloudfront.OriginRequestPolicy.fromOriginRequestPolicyId(this, "HttpOriginRequestPolicy", props.httpOriginRequestPolicyId);
