...
import { handler as addHandler } from '../../src/add/handler';
...
export const we_invoke_add = async () => {
    return await when.we_invoke_lambda(addHandler, {} as APIGatewayEvent, {} as Context);
};
